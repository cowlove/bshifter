...
class MyDialog(simpledialog.Dialog):
    ...
    def login(self):
        if (not eso.exists('//button[@class="action-button hamburger-bg"]')) and (not eso.exists('//button[@class="more hamburger-bg"]')) and (not eso.exists('//button[@class="icons-hamburger"]')):
            ...
            eso.waitPageLoaded()
            eso.cl('//input[@id="OrganizationCode"]')
            eso.sk('//input[@id="OrganizationCode"]', 'kentfd')
            eso.cl('//eso-button[@class="continue-button"]')
            eso.waitPageLoaded()
            eso.cl('//input[@id="username"]')
            eso.sk('//input[@id="username"]', 'kf0559')
            eso.cl('//input[@type="password"]')
            eso.sk('//input[@type="password"]', 'a12345')
            eso.cl('//button[@id="login-button"]') 
